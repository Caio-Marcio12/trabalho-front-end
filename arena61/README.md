...
- [ ] Componentes modularizados e carregando corretamente.
- [ ] Site totalmente responsivo em mobile/tablet/desktop.
- [ ] Checklist de acessibilidade verificado.
- [ ] Integrações externas testadas (Maps, WhatsApp, Instagram).
...
- [ ] Adicionar formulário de contato funcional com validação client-side e feedback ARIA-live.
- [ ] Melhorar acessibilidade: adicionar labels e roles ARIA, revisar pontos de foco e auditar contraste (WCAG AA).
- [ ] Implementar envio do formulário com JavaScript (fetch) e integrar a um serviço de backend ou API.
- [ ] Converter ícones para SVG otimizados e melhorar performance de imagens (lazy-loading e compressão).
- [ ] Aprender e experimentar um framework moderno (React ou Vue) para a próxima iteração do projeto.
